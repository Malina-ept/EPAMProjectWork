...
//		String actualButtonText =	driver.findElement(By.xpath("//a[@class = 'evnt-tab-link nav-link active']")).getText();
		...
		WebElement countOfCardsOnPage = driver.findElement(By.xpath("//div[@class = 'evnt-events-column cell-3']"));

		Object[] array = {driver.findElement(By.xpath("//div[@class = 'evnt-events-column cell-3']"))};
		System.out.println(array.length);

		logger.info("и сравним их количество");
		assertEquals( "Кол-во на кнопке не совпадает с кол-вом карточек на странице", countOfCardsOnButton, countOfCardsOnPage.getText());
